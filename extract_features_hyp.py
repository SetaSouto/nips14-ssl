...
l1_model = VAE_Z_X(n_x=67*4, n_hidden_q=n_h, n_z=50, n_hidden_p=n_h, nonlinear_q='softplus', nonlinear_p='softplus', type_px='bernoulli', type_qz='gaussianmarg', type_pz='gaussianmarg', prior_sd=1)
...
def transform(v, _x):
    # Recieves the values of the net and the data
...
# And now, the features are obtained by sampling the distribuitions:
